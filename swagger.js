...
const options = {
  definition: {
    ...
    tags: [
      ...
      { name: 'Profile Avatar', description: 'User Profile Avatar image upload and management' },
      { name: 'CV', description: 'CV management endpoints' },
      { name: 'Personal Info', description: 'CV Personal Information section' },
      { name: 'CV Avatar', description: 'CV Avatar image upload and management' },
      { name: 'Educations', description: 'CV Educations section' },
      { name: 'Experiences', description: 'CV Experiences section' },
      { name: 'Skills', description: 'CV Skills section' },
      { name: 'Projects', description: 'CV Projects section' },
      { name: 'Certifications', description: 'CV Certifications section' },
      { name: 'Languages', description: 'CV Languages section' },
      { name: 'Sections', description: 'CV Sections ordering and visibility' },
