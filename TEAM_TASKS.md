...
- [ ] Users *cannot* access or modify CVs belonging to other users.
...
**Description:**
A CV builder *must* be able to export CVs to PDF. This usually involves using a tool like `Puppeteer` or `pdfkit` to convert HTML/JSON to a downloadable PDF file.
